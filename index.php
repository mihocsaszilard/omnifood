...
<html lang="en">
    <head>
        ...
        <meta name="description" content="OmniFood is a premium food delivery service with lots of healthy foods for you!">
        ...
        <header class="header-background">
            <nav>
                <div class="row">
                    ...
                    <ul id="main_nav" class="main-nav js--main-nav">
                        <li><a href="#features">Food Delivery</a></li>
                        <li><a href="#works">How it works</a></li>
                        <li><a href="#cities">Our cities</a></li>
                        <li><a href="#plans">Sign up</a></li>
                    </ul>
                    <a class="mobile-nav-icon js--main-nav">
    ...
    <section class="section-cities" id="cities">
        ...
        <div class="row js--wp-3">
            <div class="col span-1-of-4 box">
                ...
                <div class="city-feature">
                <ion-icon name="thumbs-up" class="icon-small"></ion-icon>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box js--wp-4">
                    <div>
                        ...
                        <p class="plan-price-meal">That`s only 12.99$/meal</p>
                    </div>
                    <div>
                        <ul>
                ...
                <div class="plan-box">
                    ...
                    <div>
                        <ul>
                            ...
                            <li> <ion-icon name="close-outline" class="icon-small close-outline"></ion-icon>Access to newest creations</li>
                            <li> <ion-icon name="checkmark-outline" class="icon-small"></ion-icon>Free delivery</li>
                        </ul>
                    </div>
                    <div>
        ...
        <div class="row">
            ...
            <div class="col span-1-of-2">
                <ul class="social-links">
                    ...
                    <li><a href="#"><ion-icon class="logo-twitter" href="#" name="logo-twitter"></ion-icon></a></li>
